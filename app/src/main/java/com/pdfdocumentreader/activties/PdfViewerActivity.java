...
public class PdfViewerActivity extends AppBaseWithBackOnlyActivity {
    @BindView(R.id.image)
    ...
    protected AppBaseSetGet getActivityData() {
        return new AppBaseSetGet(R.layout.activity_pdf_viewer, "");
    }
...
//        pdfView.setBackgroundDrawable(dr);
    ...
    private void updateUi() {
        ...
        getSupportActionBar().setTitle(getString(R.string.app_name_with_index, index + 1, pageCount));
    }
